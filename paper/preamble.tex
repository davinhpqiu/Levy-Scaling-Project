...
% Some versions of algorithm.sty do not provide the starred (double-column)
% variant. Define it only if absent, so Algorithm 1 can span both columns;
% as a single-column float it is too tall to share a page with body text and
% is pushed onto a float page of its own.
\makeatletter
