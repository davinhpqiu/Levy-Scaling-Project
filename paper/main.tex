...
[\Ph(x,\tau)+\Ph(-x,\tau)]/2$, leaves the rescaled curves visually
indistinguishable from the raw collapse on the pilot market; the effect of
symmetrization on the collapse score itself is not quantified here.
