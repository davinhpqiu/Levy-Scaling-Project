...
of the data.
The four North American equity-index futures --- YM ($\alphah\approx 1.76$),
ER ($\alphah\approx 1.77$), NQ ($\alphah\approx 1.75$) and
ES ($\alphah\approx 1.78$) --- cluster tightly near the empirical consensus
