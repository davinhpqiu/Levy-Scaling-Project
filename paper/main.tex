...
\begin{table}[H]
  ...
  $\bar{\cdot}$ over $\varepsilon\in\{0.1,\ldots,0.5\}$, $N_\tau\in\{20,37\}$;
...
\begin{table}[H]
  ...
  \smallskip\footnotesize
  $\bar{\cdot}$ over $\varepsilon\in\{0.1,\ldots,0.5\}$, $N_\tau\in\{20,37\}$, raw.
...
\begin{table}[H]
  ...
  \smallskip\footnotesize
  $\bar{\cdot}$ over $x>0$ and all $\tau$; $\varepsilon=0.1$, $N_\tau=20$, raw.
\end{table}
...
\begin{table}[H]
  ...
  \smallskip\footnotesize
  Sorted by $\VRh_\infty\uparrow$; $\varepsilon=0.1$, $N_\tau=20$, raw, $K_{\max}=60$.
  ES/NQ/PT use the tick-scaled pipeline; compare within-column only.
\end{table}
