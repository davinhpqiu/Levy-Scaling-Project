...
dominated by an atom at the origin.
...
so bin edges fall on integer multiples of the tick and no bin
...
lag are excluded from the sum. Since $\tilde{x}$ inherits the contract's price scale through $x_{\max}$
