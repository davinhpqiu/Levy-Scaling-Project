...
\cite{MuzyBacry1993,BouchaudPotters2003,Jiang2019,Masoudi2025} exploits the prediction
...
Lo and MacKinlay \cite{LoMacKinlay1988} introduced the variance ratio, which
remains the standard tool for characterising horizon-dependent memory in
returns and has recently been generalised to the multivariate
cross-section \cite{Froseth2026},
\begin{equation}
...
in contemporary equity-index instruments \cite{Deep2025}.
...
Equity-index futures are chosen over alternative liquid asset classes such as
foreign exchange (FX) and sovereign fixed income for three reasons.
...
venues \cite{Roll1984,Bouchaud2004,ClinetPotiron2021}. Foreign exchange
markets are predominantly over-the-counter with effective spreads and price
formation mechanisms varying substantially across dealers and platforms which
complicates systematic cross-market comparison.
Third, at 1-minute frequency the price dynamics of equity-index futures are
driven by aggregate equity market risk. This constitues a single dominant risk factor
whereas fixed-income futures are governed by duration-weighted interest rate
...
estimated exponents across estimators differ by 0.35--0.55 units.
...
sample estimates are essentially free of the large discreteness-driven bias that
