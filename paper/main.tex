...
\textcite{Bachelier1900}. The Gaussian random-walk model, which predicts
...
distributional model \parencite{Mandelbrot1963,MantegnaStanley1994,Cont2001}.
...
\textit{peak-scaling} approach of \textcite{MantegnaStanley1994,MantegnaStanley1995}.
...
\parencite{Gopikrishnan1999,Weron2001,BouchaudPotters2003}.
...
\parencite{Roll1984,Bouchaud2004}. The direction of the resulting bias is
known qualitatively \parencite{BouchaudPotters2003}, but no closed-form
...
i.i.d.\ random variables \parencite{SamorodTaqqu1994,GnedenkoKolmogorov1954}.
...
\textcite{Mandelbrot1963} first proposed that asset-price increments lie in
the domain of attraction of a stable law with $\alpha\in(1,2)$.
\textcite{MantegnaStanley1994,MantegnaStanley1995} provided the first
...
\parencite{MantegnaStanley1994,BouchaudPotters2003}. \textcite{Weron2001}
...
\textcite{Gopikrishnan1999} extended the analysis to individual US stocks and
found power-law tails with exponent $\zeta\approx 3$, outside the Lévy-stable
regime in the strict sense. \textcite{Weron2001} showed this apparent
...
\textcite{Masoliver2021} and \textcite{ContMiami2023} confirms that the
...
\textcite{MantegnaStanley1994}, regresses $\log\Ph(0,\tau)$ on $\log\tau$ and
...
The \textit{collapse-quality} estimator \parencite{Drozdz2003} chooses
...
\parencite{MuzyBacry1993,BouchaudPotters2003} exploits the prediction
...
moderate samples \parencite{Uchaikin2003}, while $q\in(1,\alpha)$ are
...
simple Lévy scaling \parencite{Mandelbrot1997,MuzyBacry1993}.

\textcite{Weron2001} and \textcite{Barunik2010} document that all three of
...
\textcite{LoMacKinlay1988} introduced the variance ratio
\begin{equation}
...
correlation found at weekly horizons by \textcite{LoMacKinlay1988}. Two
mechanisms contribute. \textcite{Roll1984} showed that bid-ask bounce
generates spurious first-order autocorrelation $\rhoh(1)\approx -s^2/4$ for
effective spread $s$, a purely mechanical effect. \textcite{Bouchaud2004} and
\textcite{Farmer2006} documented that large market orders move prices but
this impact partially reverts as the order book replenishes, adding genuine
mean reversion at short horizons. \textcite{BouchaudPotters2003} (Ch.~6)
...
across a cross-section of futures markets; \textcite{BouchaudPotters2003}
...
pattern \parencite{WoodMcInishOrd1985,AndersenBollerslev1997}. The
...
\textcite{MantegnaStanley1994,MantegnaStanley1995} and with prior estimates for
equity-index instruments \parencite{Gopikrishnan1999,BouchaudPotters2003}.
...
self-similarity fails in the far tails \parencite{MantegnaStanley1995,Gopikrishnan1999}.
...
squarely within the historical Lévy-finance benchmarks of \textcite{MantegnaStanley1994,Gopikrishnan1999}.
