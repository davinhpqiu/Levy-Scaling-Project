...
\subsection{Summary: estimation pipeline}
\label{sec:methodology:summary}

Algorithm~\ref{alg:pipeline} consolidates the six steps above into a
single reproducible procedure.
...
(Equation~\eqref{eq:collapse_score}) is a heuristic measure of
